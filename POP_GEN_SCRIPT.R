# The R script for "Synthetic Population Generation with Public Health Characteristics for Spatial Agent-Based Models"  
...
# This code is adaptable for other researchers using other datasets to generate synthetic populations for various applications, and any location and time period

########################## INSTALL AND LOAD IN NEEDED R LIBARIES ######################################

install.packages(c("readxl", "dplyr", "writexl", "tidyr", "ggplot2", "pscl"))
library(readxl)
library(dplyr)
library(writexl)
library(tidyr)
...
c.names <- c("id", "male", "female", "white", "black", "hispanic", "other", "age_18_29", "age_30_49","age_50_64", "age_65_plus", "no_bachelors", "bachelors",  "income_25k_u", "income_25_50k", "income_50_100k", "income_100k_p")
...
geo_row_names <- t(census$GEOID_Data)
